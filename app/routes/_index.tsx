...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-12 flex flex-col items-center text-gray-800">
      <div className="flex flex-col space-y-8 items-center text-center pt-48 md:pt-40">
        ...
        <p className="md:text-xl">
          From haircuts to homework help, graphic design to <br /> guitar
          lessons, find or post opportunities tailored to your needs.{" "}
        </p>
