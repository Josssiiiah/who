import {
  ...
  const StylistCard: React.FC<StylistCardProps> = ({ name, description, link, image }) => (
    <div className="flex flex-col items-center bg-white rounded-lg p-6 shadow-sm text-center hover:shadow-md transition-shadow">
      ...
      <a href={link} className="text-blue-500 hover:underline">View Profile</a>
    </div>
  );
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center text-gray-800">
        <div className="flex flex-col px-6 space-y-6 text-center pt-24 md:pt-32">
          ...
          <p>
            Discover talented student hairstylists offering a range of beauty services.
            Connect with them for a fresh new look right on campus.
          </p>
        </div>
